...
plt.figure()
df = enjoy_df[(enjoy_df['ride'] == True) & (enjoy_df['short_trips'] == True)]
df.riding_time.plot(figsize=(9,5), label="enjoy", color="red")
...
df = enjoy_df[(enjoy_df['ride'] == True) & \
                    ...
                    (enjoy_df['quantile'] == True) & \
                    (enjoy_df['tot_duration_google_transit'].isnull() == False) &\
                    (enjoy_df['tot_duration_google_transit']< 100)]  
